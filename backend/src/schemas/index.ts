...
const CashFlowMonthlyDataSchema = z.object({
  ...
  operating_cf_subtotal: z.number().optional(),
  capex_acquisition: z.number(),
  asset_sale: z.number(),
  intangible_acquisition: z.number(),
  other_investing: z.number(),
  investing_cf_subtotal: z.number().optional(),
  borrowing_proceeds: z.number().optional(),
  loan_repayment: z.number().optional(),
  capital_increase: z.number(),
  dividend_payment: z.number(),
  other_financing: z.number(),
  financing_cf_subtotal: z.number().optional(),
  net_cash_change: z.number().optional(),
  cash_beginning: z.number().optional(),
  cash_ending: z.number().optional(),
