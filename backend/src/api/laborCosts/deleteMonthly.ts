...
/**
 * @api {DELETE} /api/projects/:projectId/labor-costs/:yearMonth 人件費月次削除
 * @description
 *   - 指定年月の人件費データを全件削除し、LaborCostMonth レコードも削除する
 *   - 削除後は前月の人件費が継承される
 *   - editor 以上の権限が必要
 *
 * @request
 ...
 *
 * @response
 *   成功時: { success: true, code: '', message: 'Labor costs deleted successfully',
 *             data: { yearMonth } }
 *   失敗時:
 ...
 *     "success": true,
 *     "code": "",
 *     "message": "Labor costs deleted successfully",
